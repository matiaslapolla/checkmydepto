					...
					<Grid
						...
						<Grid
							...
							<Typography
								variant='body1'
								sx={{}}>
								At CheckMyDepto, our goal is to help you find
								your next ideal home. We are an online platform
								that connects property owners with people
								searching for their next apartment. We focus on
								providing an intuitive and convenient experience
								for you to explore a wide selection of housing
								options.
							</Typography>
						</Grid>
						<Grid
							...
							<Typography
								...
								your properties, attract a targeted audience,
							...
							<Typography
								...
								directly with owners. Let CheckMyDepto be your
								key to unlocking the perfect living space.
							</Typography>
							<Typography
								variant='body1'
								sx={{}}>
								Join the revolution today - where success meets
								satisfaction. CheckMyDepto: Empowering property
								owners, fulfilling dreams.
							</Typography>
						</Grid>
						<Grid
							sx={{
							...
							<Typography
								variant='body1'
								sx={{}}>
								Depto is your new favorite place to be in. It's
								your home, your sanctuary, your office, your
								gym, it's your place of comfort. It's not just
								any other apartment. It's your depto.
							</Typography>
						</Grid>
					</Grid>
					{/* <Grid
